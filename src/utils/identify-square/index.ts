...
/**
 * function that identifies and returns current square of a given sodoku grid at a row and column index
 * @param input Object with 9x9 soducku grid, row index, and column index
 */
